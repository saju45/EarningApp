...
public class PieView extends View {
   ...
   {
       this.pieRotateListner=listener;
   ...
   public void setData(List<SpinItem> spinItemList)
   {
       ...
       this.spinItemsList=spinItemList;
       invalidate();
   ...
   protected void onDraw(Canvas canvas)
   {
       ...
       drawableBackgroundColor(canvas,defaultBackgroundColor);
       init();
   ...
   private void drawableBackgroundColor(Canvas canvas, int color)
   {
       if (color==-1)
       {
          return;
      ...
      animate().setInterpolator(new DecelerateInterpolator())
              ...
              .setListener(new Animator.AnimatorListener() {
                  ...
                  public void onAnimationEnd(Animator animation) {
                      ...
                      if (pieRotateListner!=null)
                      {
                          pieRotateListner.rotateDone(targetIndex);
                      }
                  }
